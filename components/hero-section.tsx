...
const sideLinks = [
  { icon: Map, label: "Mapa" },
  { icon: Navigation, label: "¿Cómo llegar?" },
  { icon: MapPin, label: "Actividades" },
  { icon: BookOpen, label: "Guía turística" },
]
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col px-4 pb-28 pt-16 sm:px-6 lg:pt-20">
          <div className="max-w-xl text-white">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <button className="flex items-center gap-2 rounded-full bg-brand-yellow px-6 py-3.5 text-sm font-semibold text-brand-green-dark shadow-lg transition-transform hover:scale-[1.03]">
                <Compass className="h-4 w-4" />
                Descubrí Eldorado
              </button>
              <button className="flex items-center gap-3 rounded-full bg-white/15 px-5 py-3 text-sm font-semibold text-white backdrop-blur-sm transition-colors hover:bg-white/25">
                Ver video
